...
public class DateTimeTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("1년은 " + result*365 + " ms 입니다.");
		//int 범위 벗어나면 오버flow입니다. long 변환 필요
		...
		//String.format("%15s" , ~)으로 자리 정렬 위치를 맞출 수 있습니다.
		...
		4) java.sql.Date 클래스 - 데이터베이스 다룰 떄 사용
		 * 
		 */
