...
public class C43_RedPenExam2 {
	...
	public static void main(String[] args) {
		...
		Random r = new Random();
		int size=5;		//문제 갯수
//		int max_size = MathProblem.max_size;	//size 변수값이 max_size 초과하는지 추가 검사
		...
		//아래코드는 형식일뿐, 전체적으로 수정할 내용이 많습니다. problems 배열을 활용하고 isCorrect 필드를 설정하세요.
...
//만약에 사용자가 입력한 ans를 저장해서 오답 출력시 같이 보여주고 싶다면?
