...
//		long m4 = 100;
//		
//		int currentNo; // 변수명은 실제 저장되는 값이 파악되는 단어로 만든다.
//		
...
//		
		...
		n1 = 123;		//대입문 : 오른쪽 값/수식/변수가 왼쪽 변수로 대입
						//123은 4바이트 리터럴. byte와 short 은 별도 리터럴 표기방식이 없음.
						//자동으로 값이 넘치지 않으면 1바이트 또는 2바이트로 크기가 바뀌어 저장된다.
		//n1 = 999;		//오류 : + 127보다 큰 값
		n2 = 29999;
		//n2 = -40000;	//오류 : - 32768 보다 작은 값
		n3 = 123456789;
		//n3 = 1234567890123;		//오류 : int 최대값보다 큰 값
