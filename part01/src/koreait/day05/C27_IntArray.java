...
public class C27_IntArray {
	...
	public static void main(String[] args) {
		...
		int[] arr2 = new int[7];						//배열의 크기만 설정. 기본초기값이 있나요?
		...
		String temp = Arrays.toString(arr1);		//toString은 static 메소드, 메소드의 리턴형식 string
		System.out.println();
		...
		arrayPrint(arr2, "arr2");														// 메소드의 매개변수는 참조변수(참조값 전달, 같은 메모리 위치를 가리키게 됩니다.)
	}
