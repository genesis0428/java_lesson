...
public class C47_MemberTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("list의 요소 중 참조 객체 age 필드 값이 25 이하인 것만 출력해보기");	//for문
		...
		// 리스트 요소가 여러 개의 필드를 갖는 객체이면 필드값 비교하는 equals 예제입니다.
		
		System.out.println("4. 참고");
		//						indexOf 메소드는 제너릭타입이String, 기본형 래퍼클래스만 추가적인 기능구현없이 사용합니다.
		System.out.println("Member 객체로 indexOf 실행 : " + list.indexOf(new Member("나나", 20)));	
					//-1 : 못찾음(이유 : 참조값이 같은 것을 찾는건데 이것을 필드값 비교해서 찾도록 바꾸어주는 기능 구현이 필요함.)
